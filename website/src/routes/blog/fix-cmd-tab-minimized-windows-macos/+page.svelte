...
<main class="min-h-screen bg-[#f7fafc] dark:bg-[#18181c] font-sans pt-[90px]">
  <article class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="prose-content">
      ...
      <p class="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
        Apple designed this behavior intentionally, assuming that minimized apps are "out of sight, out of mind." However, this creates a significant usability issue for users who minimize apps as part of their workflow organization rather than as a way to hide them completely.
      </p>
      ...
      <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-12 mb-6">
        The Permanent Solution: TabLift
      </h2>
      ...
      <ul class="space-y-3 mb-8">
        ...
        <li class="flex items-start">
          <span class="text-green-500 mr-3 mt-1 text-lg">✓</span>
          <span class="text-gray-700 dark:text-gray-300"><strong class="font-semibold text-gray-900 dark:text-gray-100">Completely unobtrusive</strong> – Runs silently in the background</span>
        </li>
        <li class="flex items-start">
          <span class="text-green-500 mr-3 mt-1 text-lg">✓</span>
          <span class="text-gray-700 dark:text-gray-300"><strong class="font-semibold text-gray-900 dark:text-gray-100">Open-source and transparent</strong> – Full code available on GitHub</span>
        </li>
        <li class="flex items-start">
          <span class="text-green-500 mr-3 mt-1 text-lg">✓</span>
          <span class="text-gray-700 dark:text-gray-300"><strong class="font-semibold text-gray-900 dark:text-gray-100">Minimal resource usage</strong> – Designed for efficiency</span>
        </li>
        <li class="flex items-start">
          <span class="text-green-500 mr-3 mt-1 text-lg">✓</span>
          <span class="text-gray-700 dark:text-gray-300"><strong class="font-semibold text-gray-900 dark:text-gray-100">No interference with other macOS features</strong> – Focused solution</span>
        </li>
      </ul>

      <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-12 mb-6">
        How to Install and Use TabLift
      </h2>

      <p class="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
        Getting TabLift up and running is straightforward and takes less than two minutes:
      </p>
      ...
      <ol class="space-y-4 mb-8">
        ...
        <li class="flex items-start">
          <span class="bg-blue-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-4 mt-1 flex-shrink-0">2</span>
          <div class="text-gray-700 dark:text-gray-300">
            <strong class="font-semibold text-gray-900 dark:text-gray-100">Launch the application</strong> – Double-click the downloaded .dmg file and drag TabLift to your Applications folder
          </div>
        </li>
        <li class="flex items-start">
          <span class="bg-blue-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-4 mt-1 flex-shrink-0">3</span>
          <div class="text-gray-700 dark:text-gray-300">
            <strong class="font-semibold text-gray-900 dark:text-gray-100">Grant accessibility permissions</strong> – macOS will prompt you to allow TabLift to control window management (this is required for the app to restore minimized windows)
          </div>
        </li>
        <li class="flex items-start">
      ...
      <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-400 p-6 my-8 rounded-r-lg">
        <p class="text-blue-800 dark:text-blue-200">
          <strong class="font-semibold">Privacy Note:</strong> TabLift operates entirely locally on your Mac. It doesn't collect personal data, send information to external servers, or interfere with your privacy. The accessibility permission is used solely for window management functionality.
        </p>
      </div>
      ...
      <p class="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
        TabLift is completely open-source, meaning you can review the code, contribute improvements, or even build your own version. The project welcomes community contributions and feedback.
      </p>

      <p class="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
        For technical details, bug reports, or to contribute to the project, visit the <a href="https://github.com/turtle-key/TabLift" class="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener">TabLift GitHub repository</a>.
      </p>
