...
<style>
  ...
  /* Typography */
  h1:first-of-type { display: none; } /* hide duplicate title from generator */
  ...
  /* Donation "button" (accessible anchor styled as button) */
  .donation-link {
    position: relative;
    display: inline-flex;
    align-items: center;
  ...
  .donation-link:focus-visible {
    outline: none;
    box-shadow: 0 0 0 4px rgba(99, 102, 241, 0.35); /* indigo focus */
  }
